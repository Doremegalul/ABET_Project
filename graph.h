...
void graph::DFT_helper(int v, int& i, int* num, queue<string>& q)
{
	...
	//how to iterate the library's linked list. https://www.cplusplus.com/reference/list/list/end/          
	...
	for (list<edge*>::iterator u = ver_ar[v].begin(); u != ver_ar[v].end(); u++)
	{
		...
		//Note: *u gives the element of the node pointed to by u. The element is a pointer to an edge object.          
...
/*********************************************************************************************
**********************************************************************************************                           
Compile with a c++11 option if using to_string()                                                                                                                                             
...
//This function is for checking the heap and all the arrays. 
//Note: This is not part of the graph class. It is made for testing.
